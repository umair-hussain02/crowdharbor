...
export function FAQSection() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const response = await fetch('/api/pages/home/faqs');
  ...
  return (
    <section className="bg-[var(--color-bg-white)] py-[100px] px-[24px]">
      <div className="max-w-[860px] mx-auto">
        ...
        >
          <h2
            className="text-[clamp(30px, 3.5vw, 44px)] font-extrabold text-[var(--color-text-primary)] leading-[1.15] tracking-[-0.02em] [font-family:var(--font-heading)]"
          >
          ...
          {faqs.map((faq, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[var(--color-bg-white)] rounded-[20px] overflow-hidden transition-all duration-200"
              >
                <button
                ...
                >
                  <span
                    className="text-[16px] font-semibold text-[var(--color-text-primary)] [font-family:var(--font-heading)] leading-[1.4]"
                  >
                    {faq.question}
                  </span>
                  <div
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="[padding:0_28px_24px]">
                        <p className="text-[15px] text-[var(--color-text-tertiary)] leading-[1.75] [margin:0px]">
                          {faq.answer}
                        </p>
                      </div>
                    </motion.div>
